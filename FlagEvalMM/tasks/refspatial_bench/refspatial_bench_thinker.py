config = dict(
    dataset_path="/data/lishuaibing/test_process/robobrain2-benchmark/RefSpatial-Bench",
    split="all",
    processed_dataset_path="/data/lishuaibing/test_process/robobrain2-benchmark/RefSpatial-Bench",
...
# 29.96
post_prompt2 = """Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image."""
...
# 9.65
post_prompt5 = """Format your final answer strictly as follows on the last line of your response:
Answer: [(x1, y1), (x2, y2), ..., (xn, yn)]"""
