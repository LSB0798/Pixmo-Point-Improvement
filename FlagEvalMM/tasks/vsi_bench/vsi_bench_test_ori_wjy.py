...
pre_prompt = "Please carefully view and understand the input image. It is a combined picture of multiple extracted video frames, arranged in a 5x5 grid in chronological order.\n"
