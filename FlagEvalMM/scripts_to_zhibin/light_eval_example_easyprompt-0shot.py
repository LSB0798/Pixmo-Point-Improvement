...
# CUDA_VISIBLE_DEVICES=0 python light_sh_yjp/light_eval_example_easyprompt-0shot.py all \
...
# --out_dir    light_results_yjp/basemodel-260115-easyprompt-0shot-cn-thinker \
# --iou_thr    0.5 \
# --batch_size 32

# CUDA_VISIBLE_DEVICES=7 python light_sh_yjp/light_eval_example_easyprompt-0shot.py eval \
# --pred_dir ./light_results_yjp/basemodel-260115-easyprompt-0shot/preds \
# --gt_set ./light_data/labels/green_green_val.jsonl \
# ./light_data/labels/green_yellow_val.jsonl \
# ./light_data/labels/yellow_yellow_val.jsonl \
# ./light_data/labels/yellow_green_val.jsonl \
