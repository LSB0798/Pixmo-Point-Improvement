...
DEFAULT_USER_TEXT_1 = """Please point out the indicator light on the black center back panel. Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.
"""

DEFAULT_USER_TEXT_2 = """Please point out all the indicator lights on the black center back panel. Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.
"""
...
# CUDA_VISIBLE_DEVICES=5 python light_sh_yjp/easyprompt-outputpoint-en-thinker.py all \
...
# --out_dir    light_results_yjp/easyprompt2-outputpoint-en-thinker \
# --iou_thr    0.5 \
# --batch_size 32 \
