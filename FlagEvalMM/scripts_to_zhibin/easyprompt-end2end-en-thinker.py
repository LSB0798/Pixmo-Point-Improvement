...
DEFAULT_USER_TEXT_1 = """Please state the colors of the upper and lower indicator lights in the black backplate area inside the charging cabinet shown in the image. Choose from the following options:
A. Green
B. Yellow
C. Red
...
DEFAULT_USER_TEXT_2 = """Please state the colors of the upper and lower indicator lights in the black backplate area inside the charging cabinet shown in the image. Choose from the following options:
A. Green
B. Yellow
C. Red
D. off (indicator light is off)
E. unknown (blocked or hard to distinguish)
Answer with the option's letter from the given choices directly:
option_upper, option_lower
"""

DEFAULT_USER_TEXT_3 = """Please point out all the long indicator lights on the black center back panel. Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.
"""

DEFAULT_USER_TEXT_4 = """Please point out all the long indicator lights on the black center back panel. Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.
"""
            ...
            for ex in fewshot_bank:
                ...
                messages.append({
                    ...
                    "content": [
                        ...
                        {"type": "text", "text": DEFAULT_USER_TEXT_2}
                    ],
                })
...
# CUDA_VISIBLE_DEVICES=1 python light_sh_yjp/easyprompt-end2end-en-thinker.py all \
...
# ./light_data/labels1225/yellow_unknown_val.jsonl \
# ./light_data/labels1225/yellow_yellow_val.jsonl \
# --out_dir    light_results_yjp/260128-easyprompt2-end2end-en-thinker \
# --iou_thr    0.5 \
# --batch_size 32 \
