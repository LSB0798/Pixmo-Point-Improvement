...
def generate_charge_cabinet_jsonl(
    ...
    # 生成JSONL内容
    jsonl_lines = []
    user_prompt_upper = """Please point out the upper long indicator lights on the black center back panel. Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image."""

    user_prompt_lower = """Please point out the lower long indicator lights on the black center back panel. Your answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image."""
    for img_path in img_paths:
        ...
        data = {
            "messages": [
                ...
                {"role": "user", "content": "<image>" + user_prompt_upper},
        ...
        data = {
            "messages": [
                # {"role": "system", "content": system_prompt},
                {"role": "user", "content": "<image>" + user_prompt_lower},
                {"role": "assistant", "content": "[(x,y)]"}
            ],
            "images": [img_path],
