...
DEFAULT_SYSTEM_PROMPT = """你是一个专业的充电柜指示灯检测助手。你的任务是：根据用户提供的充电柜图片，识别黑色背板区域内的指示灯位置，以json格式输出所有坐标，例如：
```json
[
...
# CUDA_VISIBLE_DEVICES=7 python light_sh_yjp/light_eval_example_hardprompt-outputbbox-only-userprompt-cn.py all \
...
# --out_dir    light_results_yjp/basemodel-260122-hardprompt-outputbbox-only-userprompt-cn \
# --iou_thr    0.5 \
# --batch_size 32
