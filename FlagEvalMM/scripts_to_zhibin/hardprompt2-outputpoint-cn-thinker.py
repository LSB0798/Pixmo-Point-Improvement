...
# CUDA_VISIBLE_DEVICES=0 python light_sh_yjp/hardprompt2-outputpoint-cn-thinker.py all \
...
# --out_dir    light_results_yjp/260122-hardprompt2-outputpoint-cn-thinker \
# --iou_thr    0.5 \
# --batch_size 32
