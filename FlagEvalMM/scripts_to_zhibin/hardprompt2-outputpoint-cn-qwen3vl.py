...
DEFAULT_SYSTEM_PROMPT = """你是一个专业的充电柜指示灯检测助手。你的任务是：在用户提供的充电柜图片中，仅检测位于“充电柜中间黑色背板区域”内的指示灯灯条，并输出其所在坐标（point），例如：
```json
[
    {"point_2d": [x, y], "label": "充电柜指示灯"},
    {"point_2d": [x, y], "label": "充电柜指示灯"}
]
```
...
# CUDA_VISIBLE_DEVICES=2 python light_sh_yjp/hardprompt2-outputpoint-cn-qwen3vl.py all \
...
# --out_dir    light_results_yjp/hardprompt2-outputpoint-cn-qwen3vl \
# --iou_thr    0.5 \
# --batch_size 32
