...
# CUDA_VISIBLE_DEVICES=2 python light_sh_yjp/light_eval_example_hardprompt2-8shot.py all \
...
# --out_dir    light_results_yjp/basemodel-260115-hardprompt2-8shot-cn-thinker \
# --iou_thr    0.5 \
# --batch_size 32
