...
BASEMODEL=/code1/data/RoboBrain2.0-7B
MODEL=eval-10-robobrain7b-20251229-1100
...
python babysitting_multi.py \
  ...
  --tasks  tasks/sat/sat.py tasks/refspatial_bench/refspatial_bench.py tasks/blink/blink_val.py tasks/where2place/where2place.py tasks/robo_spatial_home/robo_spatial_home_all.py tasks/erqa/erqa.py tasks/vsr_random/vsr_random.py \
  --cuda 5 \
  ...
  --is-lora false \
  --is-mcore false \
  --scp-dest ubt@10.10.22.57:/media/ubt/04d101c2-7eb0-4765-afd4-85d6f4b201a7/workspace/1230/robobrain7b/