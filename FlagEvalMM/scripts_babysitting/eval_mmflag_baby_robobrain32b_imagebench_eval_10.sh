...
# --tasks tasks/blink/blink_val.py tasks/cv_bench/cv_bench_test.py tasks/embspatial_bench/embspatial_bench.py tasks/robo_spatial_home/robo_spatial_home_all.py tasks/refspatial_bench/refspatial_bench_qwen3vl.py tasks/sat/sat.py tasks/vsi_bench/vsi_bench_tiny.py tasks/where2place/where2place_qwen3vl.py tasks/robovqa/robovqa.py tasks/egoplan2/egoplan2.py \
...
python babysitting_multi.py \
  ...
  --tasks  tasks/sat/sat.py tasks/refspatial_bench/refspatial_bench.py tasks/blink/blink_val.py tasks/where2place/where2place.py tasks/robo_spatial_home/robo_spatial_home_all.py tasks/erqa/erqa.py \
  --cuda 6 \
  --model-type http_robobrain \
