...
# MODEL=eval-10-iter_0001000-20251229-1100
...
python babysitting_multi.py \
  ...
  --extra-args "--limit-mm-per-prompt '{\"image\": 512, \"video\": 2}' \
                ...
                --data-parallel-size 1 --seed 3407 --max-model-len 60000 --mm-encoder-tp-mode data --trust-remote-code --gpu-memory-utilization 0.8 --allowed-local-media-path /code1 --interleave-mm-strings"  \
  --is-lora false \
  --is-mcore false \
  --scp-dest ubt@10.10.22.57:/media/ubt/04d101c2-7eb0-4765-afd4-85d6f4b201a7/workspace/1230/qwen3vl8b/