...
#tasks/robovqa/robovqa.py tasks/blink/blink_val_qwen3vl.py tasks/cv_bench/cv_bench_test.py tasks/embspatial_bench/embspatial_bench.py tasks/robo_spatial_home/robo_spatial_home_all_qwen3vl.py tasks/sat/sat_qwen3vl.py tasks/erqa/erqa_qwen3vl.py tasks/refspatial_bench/refspatial_bench_qwen3vl.py tasks/where2place/where2place_qwen3vl.py tasks/pixmo_points_eval/pixmo_points_eval_qwen3vl.py tasks/vsr_random/vsr_random.py \
...
python babysitting_multi.py \
  ...
  --tasks tasks/vsr_random/vsr_random.py tasks/pixmo_points_eval/pixmo_points_eval_qwen3vl.py \
  ...
  --extra-args "--limit-mm-per-prompt '{\"image\": 512, \"video\": 2}' \
                ...
                --tensor-parallel-size 8 --seed 3407 --max-model-len 50000 --mm-encoder-tp-mode data --trust-remote-code --gpu-memory-utilization 0.6 --allowed-local-media-path /code1 --interleave-mm-strings --enable-expert-parallel --distributed-executor-backend mp" \
  --is-lora false \
  --is-mcore false \
