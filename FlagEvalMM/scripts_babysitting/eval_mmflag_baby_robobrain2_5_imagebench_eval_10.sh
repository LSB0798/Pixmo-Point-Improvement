...
python babysitting_multi.py \
  ...
  --tasks tasks/robovqa/robovqa_robobrain2_5.py tasks/blink/blink_val_robobrain2_5.py tasks/cv_bench/cv_bench_test.py tasks/embspatial_bench/embspatial_bench.py tasks/robo_spatial_home/robo_spatial_home_all_robobrain2_5.py tasks/sat/sat_robobrain2_5.py tasks/refspatial_bench/refspatial_bench_robobrain2_5.py tasks/where2place/where2place_robobrain2_5.py tasks/pixmo_points_eval/pixmo_points_eval_robobrain2_5.py tasks/vsr_random/vsr_random.py tasks/erqa/erqa_robobrain2_5.py \
  --cuda 0 \
