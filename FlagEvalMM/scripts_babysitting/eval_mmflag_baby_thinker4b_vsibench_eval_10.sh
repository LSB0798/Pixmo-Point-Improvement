...
MODEL=eval-10-qwen3vl4b-20260113-1200-doubleq
...
python babysitting_multi.py \
  ...
  --tasks tasks/vsi_bench/vsi_bench_tiny_qwen3vl.py tasks/vsi_bench/vsi_bench_test_qwen3vl.py \
  --cuda 0,2,3,4 \
  ...
  --extra-args "--limit-mm-per-prompt '{\"image\": 512, \"video\": 2}' \
                ...
                --data-parallel-size 4 --seed 3407 --max-model-len 50000 --mm-encoder-tp-mode data --trust-remote-code --gpu-memory-utilization 0.8 --allowed-local-media-path /code1 --interleave-mm-strings"  \
  --is-lora false \
  --is-mcore false \
  --scp-dest ubt@10.10.22.57:/media/ubt/04d101c2-7eb0-4765-afd4-85d6f4b201a7/workspace/260130/qwen3vl4b-doubleq/
