    ...
    for item in q:
        if isinstance(item, dict) and item.get("type") == "image_url":
            ...
            if "base64," not in data_url:
                # 若出现 http/https URL，需要你再加下载/缓存逻辑
...
def visualize_erqa_badcases(
    json_path: str,
    out_dir: str = "erqa_badcases_vis",
    n: int = 20,
    seed: int = 0,
    wrap_width: int = 140,
    ...
    for s in picked:
        ...
        fig.suptitle("ERQA badcase | correct=False", fontsize=13)
...
if __name__ == "__main__":
    visualize_erqa_badcases(
        json_path="./results/v164-20251211-152343-alignment/iter_0008500/erqa/erqa_evaluated.json",  # 改成你的实际路径
        out_dir="badcases_vis/erqa",
        n=40,
        seed=0,
        wrap_width=140,
        max_imgs_per_row=3,
