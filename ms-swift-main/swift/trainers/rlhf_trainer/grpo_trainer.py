    ...
    def _prepare_inputs(self, generation_batch: Dict[str, Union[torch.Tensor,
        ...
        if mode == 'train':
            ...
            if self._step % generate_every == 0 or self._buffered_inputs is None:
                # print('000 generation_batch : {}'.format(generation_batch))
                """
                generation_batch : [{'task_type': 'robopoint-refer', 
                                     'messages': [{'role': 'system', 
                                                   'content': 'You are a helpful robot planner. 请根据问题推理出答案', 
                                                   'loss': None}, 
                                                  {'role': 'user', 
                                                   'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 
                                                   'loss': None}
                                                  ], 
                                     'videos': [], 
                                     'images': [], 
                                     'gt_answer': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', 
                                     'solution': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'}, 
                                    {'task_type': 'robopoint-refer', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', 'solution': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'}, 
                                    {'task_type': 'robopoint-refer', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', 'solution': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'}, 
                                    {'task_type': 'robopoint-refer', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', 'solution': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'}, 
                                    {'task_type': 'robopoint-refer', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', 'solution': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'}, 
                                    {'task_type': 'robopoint-refer', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', 'solution': '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'}, 
                ...
                generation_batch : [{'task_type': 'llava-665K', 
                                     'messages': [{'role': 'system', 
                                                   'content': 'You are a helpful robot planner. 请根据问题推理出答案', 
                                                   'loss': None}, 
                                                  {'role': 'user', 
                                                   'content': 'My react app is logged in multiple tabs, if i have to logout from one tab, i want it to logout automatically on other tabs also', 
                                                   'loss': None}], 
                                     'videos': [], 
                                     'images': [], 
                                     'gt_answer': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab.", 
                                     'solution' : "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab."}, 
                                    {'task_type': 'llava-665K', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': 'My react app is logged in multiple tabs, if i have to logout from one tab, i want it to logout automatically on other tabs also', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab.", 'solution': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab."}, 
                                    {'task_type': 'llava-665K', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': 'My react app is logged in multiple tabs, if i have to logout from one tab, i want it to logout automatically on other tabs also', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab.", 'solution': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab."}, 
                                    {'task_type': 'llava-665K', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': 'My react app is logged in multiple tabs, if i have to logout from one tab, i want it to logout automatically on other tabs also', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab.", 'solution': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab."}, 
                                    {'task_type': 'llava-665K', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': 'My react app is logged in multiple tabs, if i have to logout from one tab, i want it to logout automatically on other tabs also', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab.", 'solution': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab."}, 
                                    {'task_type': 'llava-665K', 'messages': [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': 'My react app is logged in multiple tabs, if i have to logout from one tab, i want it to logout automatically on other tabs also', 'loss': None}], 'videos': [], 'images': [], 'gt_answer': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab.", 'solution': "To achieve this functionality, you can make use of browser's `localStorage` API to store a unique identifier for the currently logged in user.\n\nWhen a user logs in to your React app, you can store their user ID in the `localStorage` by calling:\n```javascript\nlocalStorage.setItem('user', userId);\n```\nThen, you can listen to the `storage` event on the `window` object to detect changes in the `localStorage`. When a change occurs, you can check if the `user` key has been removed from the `localStorage`, which would indicate that the user has logged out from another tab.\n```javascript\nwindow.addEventListener('storage', (event) => {\nif (event.key === 'user' && !event.newValue) {\n// The user has been logged out from another tab\n// Perform any cleanup or redirection logic here\n}\n});\n```\nBy doing this, you can detect when the user has logged out from another tab and perform any necessary cleanup or redirection logic in the current tab."}, 
                ...
                # print('111 generation_batch : {}'.format(generation_batch))
                """
                generation_batch : [{'input_ids': tensor([[151644,   8948,    198,   ...,     15,   7252, 151645]], device='cuda:0'), 
                        'position_ids': tensor([[[  0,   1,   2,  ..., 216, 217, 218]],
                                                [[  0,   1,   2,  ..., 216, 217, 218]],
                                                [[  0,   1,   2,  ..., 216, 217, 218]]], device='cuda:0'), 
                        'text_position_ids': tensor([[  0,   1,   2,   ..., 216, 217, 218]], device='cuda:0'), 
                        'cu_seq_lens_q': tensor([  0, 230, 449], device='cuda:0', dtype=torch.int32), 
                        'cu_seq_lens_k': tensor([  0, 230, 449], device='cuda:0', dtype=torch.int32), 
                        'max_length_q': tensor(230, device='cuda:0', dtype=torch.int32), 
                        'max_length_k': tensor(230, device='cuda:0', dtype=torch.int32), 
                        'completion_mask': tensor([[ True,  True,  True,  ...,  True, True,  True]], device='cuda:0'), 
                        'truncated_mask': tensor([False, False], device='cuda:0'), 
                        'logits_to_keep': 322, 
                        'seq_lengths': tensor([103, 219], device='cuda:0'), 
                        'old_per_token_logps': tensor([[-5.1975e-05, ..., -3.6955e-06]], device='cuda:0', dtype=torch.bfloat16), 
                        'ref_per_token_logps': tensor([[-5.1975e-05, ..., -3.6955e-06]], device='cuda:0', dtype=torch.bfloat16), 
    ...
    def _compute_rewards_per_func(self, inputs: DataType) -> torch.Tensor:
        ...
        for i, (reward_func, reward_model_plugin, reward_func_name) in enumerate(
            ...
            with patch_profiling_context(self, reward_func_name):
                print('reward_func_name : {}'.format(reward_func_name))
                # reward model
                ...
                # reward function
                    ...
                    # print('reward_kwargs keys : {}'.format(reward_kwargs.keys()))
                    # print('reward_kwargs task_type : {}'.format(reward_kwargs['task_type']))
                    """
                    reward_kwargs keys : dict_keys(['trainer_state', 'task_type', 'messages', 'videos', 'images', 'gt_answer', 'solution', 'prompt_id', 'request_id', 'response_token_ids', 'finish_reason', 'is_truncated'])

                    completions : ['[(100, 100), (200, 200), (300, 300), (400, 400), (500, 500), (600, 600), (700, 700), (800, 800), (900, 900), (1000, 1000)]', '[(200, 200), (300, 100), (400, 400), (500, 300), (600, 200), (700, 400), (800, 100), (900, 400), (1000, 200)]', '[(200, 300), (400, 200), (600, 400), (800, 100), (100, 500)]', '[(300, 300), (500, 400), (700, 500), (900, 600), (200, 700), (400, 800), (600, 900)]', '[(300, 400), (500, 300), (700, 600), (200, 800), (900, 200)]', '[(100, 100), (200, 200), (300, 300), (400, 400), (500, 500), (600, 600), (700, 700), (800, 800), (900, 900), (1000, 1000)]', '[(300, 300), (500, 400), (700, 500), (900, 600), (200, 700), (400, 800), (600, 900)]', '[(200, 300), (400, 200), (600, 400), (800, 100), (100, 500)]']
                    reward_kwargs : {'trainer_state': TrainerState(epoch=0, global_step=0, max_steps=7146, logging_steps=1, 
                                                                   eval_steps=1000.0, save_steps=1000, train_batch_size=2, 
                                                                   num_train_epochs=1, num_input_tokens_seen=0, total_flos=0, 
                                                                   log_history=[], best_metric=None, best_global_step=None, 
                                                                   best_model_checkpoint=None, is_local_process_zero=True, 
                                                                   is_world_process_zero=True, is_hyper_param_search=False, 
                                                                   trial_name=None, trial_params=None, 
                                                                   stateful_callbacks={'TrainerControl': {'args': {'should_training_stop': False, 'should_epoch_stop': False, 
                                                                                                                   'should_save': False, 'should_evaluate': False, 'should_log': False}, 
                                                                                                          'attributes': {}
                                                                                                          }}), 
                                    'task_type': ['robopoint-refer', 'robopoint-refer', 'robopoint-refer', 
                                                    'robopoint-refer', 'robopoint-refer', 'robopoint-refer', 
                                                    'robopoint-refer', 'robopoint-refer'], 
                                    'messages': [[{'role': 'system', 
                                                    'content': 'You are a helpful robot planner. 请根据问题推理出答案', 
                                                    'loss': None}, 
                                                    {'role': 'user', 
                                                    'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, 
                                                    {'role': 'assistant', 
                                                    'content': '[(100, 100), (200, 200), (300, 300), (400, 400), (500, 500), (600, 600), (700, 700), (800, 800), (900, 900), (1000, 1000)]'}], 
                                                    
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(200, 200), (300, 100), (400, 400), (500, 300), (600, 200), (700, 400), (800, 100), (900, 400), (1000, 200)]'}], 
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(200, 300), (400, 200), (600, 400), (800, 100), (100, 500)]'}], 
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(300, 300), (500, 400), (700, 500), (900, 600), (200, 700), (400, 800), (600, 900)]'}], 
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(300, 400), (500, 300), (700, 600), (200, 800), (900, 200)]'}], 
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(100, 100), (200, 200), (300, 300), (400, 400), (500, 500), (600, 600), (700, 700), (800, 800), (900, 900), (1000, 1000)]'}], 
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(300, 300), (500, 400), (700, 500), (900, 600), (200, 700), (400, 800), (600, 900)]'}], 
                                                    [{'role': 'system', 'content': 'You are a helpful robot planner. 请根据问题推理出答案', 'loss': None}, {'role': 'user', 'content': '<image>\nThe image displays an area outlined by a red rectangle. Locate several points within the vacant space on the outlined area. \nYour answer should be formatted as a list of tuples, i.e. [(x1, y1), (x2, y2), ...], where each tuple contains the x and y coordinates of a point satisfying the conditions above. The coordinates should range from 0 to 1000, representing the relative pixel positions of the points in the image.', 'loss': None}, {'role': 'assistant', 'content': '[(200, 300), (400, 200), (600, 400), (800, 100), (100, 500)]'}]], 
                                    'videos': [[], [], [], [], [], [], [], []], 
                                    'images': [[], [], [], [], [], [], [], []], 
                                    'gt_answer': ['[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]'], 
                                    'solution': ['[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)]', '[(530, 560), (508, 552), (483, 562), (556, 565), (531, 581), (502, 573)
, 701, 320, 24, 15, 15, 11, 220, 17, 15, 15, 7252], [9697, 16, 15, 15, 11, 220, 16, 15, 15, 701, 320, 17, 15, 15, 11, 220, 17, 15, 15, 701, 320, 18, 15, 15, 11, 220, 18, 15, 15, 701, 320, 19, 15, 15, 11, 220, 19, 15, 15, 701, 320, 20, 15, 15, 11, 220, 20, 15, 15, 701, 320, 21, 15, 15, 11, 220, 21, 15, 15, 701, 320, 22, 15, 15, 11, 220, 22, 15, 15, 701, 320, 23, 15, 15, 11, 220, 23, 15, 15, 701, 320, 24, 15, 15, 11, 220, 24, 15, 15, 701, 320, 16, 15, 15, 15, 11, 220, 16, 15, 15, 15, 7252], [9697, 18, 15, 15, 11, 220, 18, 15, 15, 701, 320, 20, 15, 15, 11, 220, 19, 15, 15, 701, 320, 22, 15, 15, 11, 220, 20, 15, 15, 701, 320, 24, 15, 15, 11, 220, 21, 15, 15, 701, 320, 17, 15, 15, 11, 220, 22, 15, 15, 701, 320, 19, 15, 15, 11, 220, 23, 15, 15, 701, 320, 21, 15, 15, 11, 220, 24, 15, 15, 7252], [9697, 17, 15, 15, 11, 220, 18, 15, 15, 701, 320, 19, 15, 15, 11, 220, 17, 15, 15, 701, 320, 21, 15, 15, 11, 220, 19, 15, 15, 701, 320, 23, 15, 15, 11, 220, 16, 15, 15, 701, 320, 16, 15, 15, 11, 220, 20, 15, 15, 7252]], 
                                    'finish_reason': ['stop', 'stop', 'stop', 'stop', 'stop', 'stop', 'stop', 'stop'], 
                                    'is_truncated': [False, False, False, False, False, False, False, False]}
                    """
                    output_reward_func = reward_func(completions, **reward_kwargs)
                    print('222 output_reward_func : {}'.format(output_reward_func))
    ...
    def _prepare_rewards(self, reward_funcs, reward_model=None, **kwargs):
        ...
        if reward_funcs:
            for i, reward_func in enumerate(reward_funcs):
                """ i : 0, reward_func : accuracy, reward_func_class : <class 'swift.plugin.orm.MathAccuracy'>
                    i : 1, reward_func : format,   reward_func_class : <class 'swift.plugin.orm.Format'> """
                if reward_func in orms:
                    ...
                    """ i = 0, reward_funcs : [<swift.plugin.orm.MathAccuracy object at 0x78455b678820>, 'format']
                        i = 1, reward_funcs : [<swift.plugin.orm.MathAccuracy object at 0x78455b678820>, <swift.plugin.orm.Format object at 0x78455b67a2f0>]"""
        ...
        self.reward_model_plugins = [None] * len(self.reward_funcs) # self.reward_func_names : ['MathAccuracy', 'Format']

        if reward_model is not None: # reward_model : None
        ...
        # Reward weights
        if args.reward_weights is not None: # args.reward_weights : None
        ...
        # self.reward_weights : tensor([1., 1.], device='cuda:0')
        ...
        """ self.reward_funcs : [<swift.plugin.orm.MathAccuracy object at 0x754fab60c1f0>, 
                                 <swift.plugin.orm.Format object at 0x754fab60cb20>] """
